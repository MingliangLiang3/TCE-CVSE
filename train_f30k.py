...
def main():
    ...
    parser.add_argument('--alpha', default=0.85, type=float, help='The weight of fuse instance and consensus')
    parser.add_argument('--t', default=0.3, type=float, help='The threshold of adj metrix')
    parser.add_argument('--adj_gen_mode', default='Complex', help='The mode of gen adj metrix')
...
def validate(opt, val_loader, model):
    ...
    img_embs, cap_embs, img_emb_cons, cap_emb_cons, concept_labels = encode_data(model = model, data_loader = val_loader, alpha = opt.alpha)
